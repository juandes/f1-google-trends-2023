...
```{r}
setwd("~/Development/f1-2023-google-trends/qatar")
df <- read.csv("~/Development/f1-2023-google-trends/qatar/data/interest.csv")
```
...
p <- ggplot(df, aes(x = tzts, y = interest)) +
  ...
  labs(title="Google Trends' Interest over time of the phrase \"formula 1\"",
       subtitle = "Queried on Sunday, October 8, 2023 at 18:45 UTC") +
