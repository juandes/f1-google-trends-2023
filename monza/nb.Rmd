...
```{r}
setwd("~/Development/f1-2023-google-trends/monza")
df <- read.csv("~/Development/f1-2023-google-trends/monza/data/df.csv")
```
...
p <- ggplot(df, aes(x = tzts, y = interest)) +
  ...
  labs(title="Google Trends' Interest over time of the phrase \"formula 1\"",
       subtitle = "Queried on Sunday, September 3, 2023 at 15:00 UTC") +
